Feature: Managing restaurant preparationCapacity
  ...
  Scenario:
    Given an order with the status "CREATED" in the restaurant "512EatRestaurant" with a chosen dish "cheesburger" with a production capacity of 5 and an average preparation time of 10 min with a delivery time at 12:50
